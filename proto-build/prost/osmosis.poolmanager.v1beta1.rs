...
pub struct TakerFeesTracker {
    #[prost(message, repeated, tag="1")]
    pub taker_fees_to_stakers: ::prost::alloc::vec::Vec<::cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(message, repeated, tag="2")]
    pub taker_fees_to_community_pool: ::prost::alloc::vec::Vec<::cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(int64, tag="3")]
